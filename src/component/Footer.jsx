...
const Footer = () =>{
    return (
                ...
                <div className="row">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-link-contact">
                            ...
                            <li><FaMailBulk/> Email: <a href="#">phanhoangphuc0311@gmail.com</a></li>
        ...
        <p class="footer-company">All Rights Reserved. &copy; 2022 <a href="#" style={{}}>English examination system</a> Design By: 
